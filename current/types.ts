...
import { FoodMapper, MealMapper } from './mappers.js';
...
export type FoodResolvers<ContextType = any, ParentType extends ResolversParentTypes['Food'] = ResolversParentTypes['Food']> = ResolversObject<{
